...
(function($) {
	...
	itemSku = {
		...
		additemsku : function() {
			...
			var applicable_tax_rate = '';
			if( undefined != $( "#newsku_applicable_tax_rate" ) ) {
				applicable_tax_rate = $( "#newsku_applicable_tax_rate option:selected" ).val();
			}
...
//				mes += '<p>'+uscesL10n.message[6]+'</p>';
			...
			if( '' != applicable_tax_rate ) {
				s.data += "&newskutaxrate=" + applicable_tax_rate;
			}
			s.success = function(data, dataType){
		...
		updateitemsku : function(meta_id) {
			...
			var sortnum = $(so).val();
			var applicable_tax_rate = '';
			if( undefined != $( "select[name='itemsku\["+meta_id+"\]\[applicable_tax_rate\]']" ) ) {
				applicable_tax_rate = $( "select[name='itemsku\["+meta_id+"\]\[applicable_tax_rate\]'] option:selected" ).val();
			}
			...
			if( '' != applicable_tax_rate ) {
				s.data += "&skutaxrate=" + applicable_tax_rate;
			}
			s.success = function(data, dataType){
