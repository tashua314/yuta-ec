...
<table class="form_table">
	...
	<tr>
		<th><a style="cursor:pointer;" onclick="toggleVisibility( 'ex_applicable_tax_rate' );"><?php _e( 'Applicable tax rate', 'usces' ); ?></a></th>
		<td width="10"><input name="applicable_tax_rate" id="applicable_tax_rate_standard" type="radio" value="standard"<?php if( $this->options['applicable_tax_rate'] == 'standard' ) echo 'checked="checked"'; ?> /></td><td width="60"><label for="applicable_tax_rate_standard"><?php _e( 'Standard tax rate', 'usces' ); ?></label></td>
		<td width="10"><input name="applicable_tax_rate" id="applicable_tax_rate_reduced" type="radio" value="reduced"<?php if( $this->options['applicable_tax_rate'] == 'reduced' ) echo 'checked="checked"'; ?> /></td><td width="60"><label for="applicable_tax_rate_reduced"><?php _e( 'Reduced tax rate', 'usces' ); ?></label></td>
		<td><div id="ex_applicable_tax_rate" class="explanation"><?php _e( 'Select whether to applying reduced tax rate.', 'usces' ); ?></div></td>
	</tr>
</table>
<table class="form_table">
	<tr>
